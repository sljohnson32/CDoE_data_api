...
const createELAMathScoreMetric = (knex, metric) => {
  ...
  return knex('school_cmas_ela_math').insert({
    ...
    number_met_exceeded_expectations_total: metric.number_met_exceeded_expectations_total.replace(/,/g, ''),
...
const createSATPSATMetric = (knex, metric) => {
  ...
  return knex('school_sat_psat').insert({
    ...
    students_total: metric.students_total.replace(/,/g, ''),
    valid_scores_total: metric.valid_scores_total.replace(/,/g, ''),
